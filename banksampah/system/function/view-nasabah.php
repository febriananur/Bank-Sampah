    ...
    <br>
      ...
      <div class="form-group">
         ...
         <div class="form-group">
          ...
          <input class="form-control" type="text" style="cursor: not-allowed;" disabled="disabled" value="<?php echo @$_SESSION['nama_n']; ?>"/>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
          ...
          <input class="form-control" type="text" style="cursor: not-allowed;" disabled="disabled" value="<?php echo @$_SESSION['telepon_n']; ?>"/>
         </div>
         <div class="form-group">
          <label class="">E-mail</label>
          <input class="form-control" type="text" style="cursor: not-allowed;" disabled="disabled" value="<?php echo @$_SESSION['email_n']; ?>"/>
         </div>
         <div class="form-group">
          <label class="">Password</label>
          <input class="form-control" type="password" style="cursor: not-allowed;" disabled="disabled" value="<?php echo @$_SESSION['pass_n']; ?>"/>
         </div>
         <div class="form-group">
         ...
         <input class="form-control" type="button" onclick="window.location='nasabah.php?page=edit-nasabah';" value="Edit Data" style="background-color:#19f73e;" />
         <br>
         </div>       
      </div>
    </div>
